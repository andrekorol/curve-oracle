...
library Rlp {
    ...
    /// @return An Item
    function toItem(bytes memory self, bool strict)
        internal
        pure
        returns (Item memory)
    {
    ...
    function iterator(Item memory self)
        internal
        pure
    ...
    function _decode(Item memory self)
        private
        pure
    ...
    function _copyToBytes(
        ...
        assembly {
            ...
            for {
                ...
                let offset := mul(i, 32)
                mstore(
                    add(destinationPointer, offset),
                    mload(add(sourcePointer, offset))
                )
            }
    ...
    function rlpBytesToUint256(bytes memory source)
        internal
        pure
